package com.jflores.springboot.error.app.controllers;
...
import com.jflores.springboot.error.app.errors.UsuarioNoEncontradoException;
import com.jflores.springboot.error.app.models.domain.Usuario;
import com.jflores.springboot.error.app.services.UsuarioService;
...
public class AppController {
	...
	public String index() {
		//Integer valor = 100/0;
		Integer valor = Integer.parseInt("10xwd");
		return "index";
	}
